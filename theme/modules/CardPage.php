                ...
                <div class="wrapper-11 bg-white">
                    <div class="pd-top-10 pd-left-10 pd-right-10">
                        <div class="flex ac">
                            ...
                            <div xif="Card.traceback.province!==null">
                                <div class="flex ac">
                                    <svg class="mg-left-2 mg-right-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 15v-4H7v-2h5V7l5 5-5 5z"></path></svg>
                                    <div class="subtext text-6 fw-3">{{UtilSvc.text.clean(Card.traceback.province)}}</div>
                                </div>
                            </div>
                        </div>
